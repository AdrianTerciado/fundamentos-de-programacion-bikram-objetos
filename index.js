...
const Coche = {marca:"S", modelo:"S", matricula:"WS"};
...
let marcaPortatil2 = Portátil[“marca”];
...
Imprimiendo.imprimiendo = {nombreArchivo:””, copias:””; numPaginas:””}
...
const Avion ={numPasajeros:””, despegar: function despegar(){console.log('despegando’)};, volar: function volar {(console.log(“llegando al destino”)};, aterrizar: function aterrizar {(console.log('aterrizando’};}
...
Pantalla.dimensiones = “1980x1080”;
